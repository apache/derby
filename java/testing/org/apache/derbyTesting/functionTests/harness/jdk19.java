/*
   ...
   Derby - Class org.apache.derbyTesting.functionTests.harness.jdk19
...
public class jdk19 extends jvm {
    ...
    public void appendOtherFlags(StringBuffer sb) {
        if (noasyncgc) warn("jdk19 does not support noasyncgc");
        if (verbosegc) sb.append(" -verbose:gc");
        if (noclassgc) sb.append(" -Xnoclassgc");
        if (ss>=0) warn("jdk19 does not support ss");
        if (oss>=0) warn("jdk19 does not support oss");
        if (ms>=0) {
            sb.append(" -ms");
            sb.append(ms);
        }
        ...
        if (verify) warn("jdk19 does not support verify");
        if (noverify) warn("jdk19 does not support noverify");
