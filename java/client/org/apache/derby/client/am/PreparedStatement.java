                                          ...
                                          PreparedStatementCallbackInterface
{
  ...
  { parameters_[parameterIndex-1] = input; parameterSet_[parameterIndex-1] = true; }
  ...
  int executeUpdateX () throws SqlException
  {
    ...
    if (sqlMode_ == isUpdate__) super.checkExecuteUpdatePostConditions ("java.sql.PreparedStatement");
    return updateCount_;
  }
  ...
  {
    synchronized (connection_) {
      if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "setNull", parameterIndex, jdbcType);
  ...
  {
    synchronized (connection_) {
      if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "setNull", parameterIndex, jdbcType, typeName);
  ...
  {
    synchronized (connection_) {
      if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "setBoolean", parameterIndex, x);
      parameterIndex = checkSetterPreconditions (parameterIndex);
  ...
  {
    synchronized (connection_) {
      if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "setByte", parameterIndex, x);
      parameterIndex = checkSetterPreconditions (parameterIndex);
  ...
  {
    synchronized (connection_) {
      if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "setShort", parameterIndex, x);
  ...
  {
    synchronized (connection_) {
      if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "setInt", parameterIndex, x);
  ...
  {
    synchronized (connection_) {
      if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "setLong", parameterIndex, x);
      parameterIndex = checkSetterPreconditions (parameterIndex);
  ...
  {
    synchronized (connection_) {
      if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "setFloat", parameterIndex, x);
      parameterIndex = checkSetterPreconditions (parameterIndex);
  ...
  {
    synchronized (connection_) {
      if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "setDouble", parameterIndex, x);
      parameterIndex = checkSetterPreconditions (parameterIndex);
  ...
  {
    synchronized (connection_) {
    if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "setBigDecimal", parameterIndex, x);
      parameterIndex = checkSetterPreconditions (parameterIndex);
	  parameterMetaData_.clientParamtertype_[parameterIndex -1] = java.sql.Types.DECIMAL;   
	  if (x == null) { setNull (parameterIndex, java.sql.Types.DECIMAL); return; }
  ...
  {
    synchronized (connection_) {
      if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "setDate", parameterIndex, x);
      parameterIndex = checkSetterPreconditions (parameterIndex);
  ...
  {
    synchronized (connection_) {
      if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "setDate", parameterIndex, x, calendar);
  ...
  {
    synchronized (connection_) {
      if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "setTime", parameterIndex, x);
      parameterIndex = checkSetterPreconditions (parameterIndex);
  ...
  {
    synchronized (connection_) {
      if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "setTime", parameterIndex, x, calendar);
      if (calendar == null) throw new SqlException (agent_.logWriter_, "Invalid parameter: calendar is null");
      java.util.Calendar targetCalendar = java.util.Calendar.getInstance(calendar.getTimeZone());
      targetCalendar.clear();
      targetCalendar.setTime(x);
  ...
  {
    synchronized (connection_) {
      if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "setTimestamp", parameterIndex, x);
      parameterIndex = checkSetterPreconditions (parameterIndex);
	  parameterMetaData_.clientParamtertype_[parameterIndex -1 ] = java.sql.Types.TIMESTAMP;

      if (x == null) { setNull (parameterIndex, java.sql.Types.TIMESTAMP); return; }
      setInput (parameterIndex, x);
  ...
  {
    synchronized (connection_) {
      if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "setTimestamp", parameterIndex, x, calendar);
      if (calendar == null) throw new SqlException (agent_.logWriter_, "Invalid parameter: calendar is null");
      java.util.Calendar targetCalendar = java.util.Calendar.getInstance(calendar.getTimeZone());
      targetCalendar.clear();
      targetCalendar.setTime(x);
  ...
  {
    synchronized (connection_) {
      if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "setString", parameterIndex, x);
  ...
  void setStringX (int parameterIndex, String x) throws SqlException
  {
      ...
      if (x == null) { setNull (parameterIndex, java.sql.Types.LONGVARCHAR); return; }
	  setInput(parameterIndex, x);
    }
  ...
  {
    synchronized (connection_) {
      if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "setBytes", parameterIndex, x);
  ...
  public void setBytesX (int parameterIndex, byte[] x) throws SqlException
  {
      ...
      if (x == null) { setNull (parameterIndex, java.sql.Types.LONGVARBINARY); return; }
	  setInput(parameterIndex, x);
  ...
  {
    synchronized (connection_) {
      if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "setBinaryStream", parameterIndex, "<input stream>", length);
  ...
  {
    synchronized (connection_) {
      if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "setAsciiStream", parameterIndex, "<input stream>", length);
      parameterIndex = checkSetterPreconditions (parameterIndex);
  ...
  {
    synchronized (connection_) {
      if (agent_.loggingEnabled()) agent_.logWriter_.traceDeprecatedEntry (this, "setUnicodeStream", parameterIndex, "<input stream>", length);
      parameterIndex = checkSetterPreconditions (parameterIndex);
	  parameterMetaData_.clientParamtertype_[parameterIndex -1] = java.sql.Types.CLOB;
      if (x == null) { setNull (parameterIndex, java.sql.Types.CLOB); return; }
  ...
  {
    synchronized (connection_) {
      if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "setCharacterStream", parameterIndex, x, length);
      parameterIndex = checkSetterPreconditions (parameterIndex);
	  parameterMetaData_.clientParamtertype_[parameterIndex -1] = java.sql.Types.CLOB;
      if (x == null) { setNull (parameterIndex, java.sql.Types.CLOB); return; }
  ...
  {
    synchronized (connection_) {
      if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "setBlob", parameterIndex, x);
  ...
  {
    synchronized (connection_) {
      if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "setClob", parameterIndex, x);
  ...
  {
    synchronized (connection_) {
      if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "setArray", parameterIndex, x);
      parameterIndex = checkSetterPreconditions (parameterIndex);
  ...
  {
    synchronized (connection_) {
      if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "setRef", parameterIndex, x);
      parameterIndex = checkSetterPreconditions (parameterIndex);
      throw new SqlException (agent_.logWriter_, "jdbc 2 method not yet implemented");
    }
  }
  ...
  {
    synchronized (connection_) {
      if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "setObject", parameterIndex, x);
      super.checkForClosedStatement();
      ...
      else if (x instanceof java.math.BigDecimal) setBigDecimal (parameterIndex, (java.math.BigDecimal) x);
      else if (x instanceof java.sql.Date)        setDate (parameterIndex, (java.sql.Date) x);
      else if (x instanceof java.sql.Time)        setTime (parameterIndex, (java.sql.Time) x);
      else if (x instanceof java.sql.Timestamp)   setTimestamp (parameterIndex, (java.sql.Timestamp) x);
      else if (x instanceof java.sql.Blob)        setBlob (parameterIndex, (java.sql.Blob) x);
      else if (x instanceof java.sql.Clob)        setClob (parameterIndex, (java.sql.Clob) x);
      else if (x instanceof java.sql.Array)       setArray (parameterIndex, (java.sql.Array) x);
      else if (x instanceof java.sql.Ref)         setRef (parameterIndex, (java.sql.Ref) x);
  ...
  {
    synchronized (connection_) {
      if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "setObject", parameterIndex, x, targetJdbcType);
  ...
  {
    if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "executeUpdate", autoGeneratedKeys);
    throw new SqlException (agent_.logWriter_,
  ...
  {
    if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "executeUpdate", columnNames);
      throw new SqlException (agent_.logWriter_,
  ...
  {
    if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "executeUpdate", columnIndexes);
      throw new SqlException (agent_.logWriter_,
  ...
  {
    if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "setURL", parameterIndex, x);
  ...
  {
    synchronized (connection_) {
      if (agent_.loggingEnabled()) agent_.logWriter_.traceEntry (this, "getParameterMetaData");
      Object parameterMetaData = getParameterMetaDataX();
      if (agent_.loggingEnabled()) agent_.logWriter_.traceExit (this, "getParameterMetaData", parameterMetaData);
  ...
  public void completeDescribeInput (ColumnMetaData parameterMetaData, Sqlca sqlca)
  {
    ...
    if (agent_.loggingEnabled()) agent_.logWriter_.traceParameterMetaData (this, parameterMetaData_);
  }
  ...
  public void completeDescribeOutput (ColumnMetaData resultSetMetaData, Sqlca sqlca)
  {
    ...
    if (sqlcode < 0) return;
    resultSetMetaData_ = resultSetMetaData;
    if (agent_.loggingEnabled()) agent_.logWriter_.traceResultSetMetaData (this, resultSetMetaData);
  }
