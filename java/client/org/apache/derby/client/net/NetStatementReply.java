...
public class NetStatementReply extends NetPackageReply implements StatementReplyInterface
{
                                ...
                                int columnNumber) throws DisconnectException
  {
    ...
    if (columnMetaData.sqlName_ == null) columnMetaData.sqlName_ = new String[columnMetaData.columns_];
    if (columnMetaData.sqlLabel_ == null) columnMetaData.sqlLabel_ = new String[columnMetaData.columns_];
    if (columnMetaData.sqlUnnamed_ == null) columnMetaData.sqlUnnamed_ = new short[columnMetaData.columns_];
                              ...
                              int column) throws DisconnectException
  {
    ...
    if (columnMetaData.sqlxKeymem_ == null) columnMetaData.sqlxKeymem_ = new short[columnMetaData.columns_];
    if (columnMetaData.sqlxGenerated_ == null) columnMetaData.sqlxGenerated_ = new short[columnMetaData.columns_];
    ...
    if (columnMetaData.sqlxUpdatable_ == null) columnMetaData.sqlxUpdatable_ = new int[columnMetaData.columns_];
